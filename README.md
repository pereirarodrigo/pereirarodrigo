...
I'm currently focused on the field of Natural Language Processing (NLP), with emphasis on the following subjects: topic modelling, natural language understanding and generation (NLU and NLG) and transformers (GPT-2, GPT-Neo and BERT). 
